...
import org.emberstudios.engine.util.toDisplayName
...
class GameObject(
	...
	override fun inspect() {
		...
		for (component in components) {
			...
			val displayName = kClass.simpleName!!.toDisplayName()
				...
				for (property in kClass.members) {
					...
					when (property.returnType.classifier) {
						Boolean::class -> {
							...
							if (ImGui.checkbox(property.name.toDisplayName(), imBool))
						...
						Int::class -> {
							...
							if (ImGui.dragInt(property.name.toDisplayName(), imInt))
						...
						Float::class -> {
							...
							if (ImGui.dragFloat(property.name.toDisplayName(), imFloat, 0.01f))
						...
						Vector2i::class -> {
							...
							if (ImGui.dragInt2(property.name.toDisplayName(), imVec2i))
						...
						Vector3i::class -> {
							...
							if (ImGui.dragInt3(property.name.toDisplayName(), imVec3i))
						...
						Vector4i::class -> {
							...
							if (ImGui.dragInt4(property.name.toDisplayName(), imVec4i))
						...
						Vector2f::class -> {
							...
							if (ImGui.dragFloat2(property.name.toDisplayName(), imVec2f, 0.01f))
						...
						Vector3f::class -> {
							...
							if (ImGui.dragFloat3(property.name.toDisplayName(), imVec3f, 0.01f))
						...
						Vector4f::class -> {
							...
							if (ImGui.dragFloat4(property.name.toDisplayName(), imVec4f, 0.01f))
						...
						Color::class -> {
							...
							if (ImGui.colorEdit4(property.name.toDisplayName(), imColor))
						...
						String::class -> {
							...
							if (ImGui.inputText(property.name.toDisplayName(), imStr))
